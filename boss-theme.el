...
(boss-with-color-variables
  (custom-theme-set-faces
   ...
   ;; company-mode
   `(company-tooltip ((t :foreground ,boss-fg :background ,boss-bg-shadow)))
   `(company-tooltip-annotation ((t :inherit company-tooltip)))
   `(company-tooltip-selection ((t :foreground ,boss-blue-dark :background ,boss-bg-light :weight bold)))
   ...
   `(company-tooltip-mouse ((t :inherit company-tooltip :background ,boss-bg-light)))
   `(company-preview ((t :background ,boss-bg)))
   `(company-preview-common ((t :foreground ,boss-red :background ,boss-bg)))
