...
(defvar boss-colors-alist
  '(("boss-cursor"        . "#303030")
    ...
    ("boss-base-light"    . "#00D7FF")
    ("boss-base-med"      . "#00AFFF")
    ("boss-base-dark"     . "#0087FF")
...
(boss-with-color-variables
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((t :foreground ,boss-base-light)))
   ...
   ;; ivy
   `(ivy-current-match ((t :foreground ,boss-base-dark :weight bold)))
