...
(boss-with-color-variables
  (custom-theme-set-faces
   ...
   ;; magit
   `(magit-section-heading ((t :foreground ,boss-blue-dark :weight bold)))
   `(magit-section-heading-selection ((t :foreground ,boss-purple)))
   ...
   `(magit-diff-file-heading-selection ((t :background ,boss-bg-light :weight bold)))
   ...
   `(magit-log-author ((t :foreground ,boss-red)))
   ...
   `(magit-bisect-skip ((t :foreground ,boss-blue-med)))
   `(magit-bisect-bad ((t :foreground ,boss-red)))
   `(magit-blame-heading ((t :background ,boss-bg-light :foreground ,boss-red-bright)))
   `(magit-blame-hash ((t :background ,boss-bg-highlight :foreground ,boss-purple)))
   `(magit-blame-name ((t :background ,boss-bg-highlight :foreground ,boss-blue-med)))
   `(magit-blame-date ((t :background ,boss-bg-highlight :foreground ,boss-yellow)))
   `(magit-blame-summary ((t :background ,boss-bg-highlight :foreground ,boss-fg)))
   `(magit-dimmed ((t :foreground ,boss-mono-med)))
   `(magit-hash ((t :foreground ,boss-purple)))
   `(magit-tag ((t :foreground ,boss-red :weight bold)))
   `(magit-branch-remote ((t :foreground ,boss-yellow :weight bold)))
